        ...
        <div class="container custom-container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-3 col-lg-4 d-none d-lg-block">
                    <div class="logo">
                        <a href="index.html"><img src="public/logo.png" alt="THong"></a>
                    </div>
                </div>
                            ...
                            <li class="header-shop-cart"><a href="cart.html"><i class="flaticon-shopping-bag"></i><span>0</span></a>
                                <ul class="minicart">
                                    <li class="d-flex align-items-start">
                                        <div class="cart-img">
                                            <a href="#"><img src="public/layouts/img/product/cart_p01.jpg" alt=""></a>
                                        </div>
                                    ...
                                    <li class="d-flex align-items-start">
                                        <div class="cart-img">
                                            <a href="#"><img src="public/layouts/img/product/cart_p02.jpg" alt=""></a>
                                        </div>
                                        <div class="cart-content">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="menu-wrap">
                        <nav class="menu-nav show">
                            <div class="logo d-block d-lg-none">
                                <a href="index.html" class="main-logo"><img src="public/layouts/img/logo/w_logo.png" alt="Logo"></a>
                                <a href="index.html" class="sticky-logo"><img src="public/layouts/img/logo/logo.png" alt="Logo"></a>
                            </div>
                                        ...
                                        <ul class="cat-mega-menu">
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="cat-mega-menu-banner"><a href="#"><img src="public/layouts/img/images/megamenu_banner.jpg" alt=""></a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                ...
                                <ul class="navigation">
                                    <li class="active menu-item-has-children has--mega--menu"><a href="#">Home</a>
                                        <ul class="mega--menu--wrap scroll">
                                            <li class="active">
                                                <a href="index.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_01.jpg" alt=""></span>
                                                    <span class="text">Home style One</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-2.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_02.jpg" alt=""></span>
                                                    <span class="text">Home style Two</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-3.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_03.jpg" alt=""></span>
                                                    <span class="text">Home style Three</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-4.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_04.jpg" alt=""></span>
                                                    <span class="text">Home style four</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-5.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_05.jpg" alt=""></span>
                                                    <span class="text">Home style five</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-6.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_06.jpg" alt=""></span>
                                                    <span class="text">Home style six</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-7.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_07.jpg" alt=""></span>
                                                    <span class="text">Home style seven</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-8.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_08.jpg" alt=""></span>
                                                    <span class="text">Home style eight</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index-9.html">
                                                    <span class="img"><img src="public/layouts/img/home-demo/home_09.jpg" alt=""></span>
                                        ...
                                        <ul class="mega-menu">
                                            <li class="mega-menu-wrap">
                                                ...
                                                <ul class="mega-menu-col sub-cat-post">
                                                    <li>
                                                        <a href="shop-sidebar.html">
                                                            <img src="public/layouts/img/product/sub_menu_img01.jpg" alt="">
                                                ...
                                                <ul class="mega-menu-col sub-cat-post">
                                                    <li>
                                                        <a href="shop-sidebar.html">
                                                            <img src="public/layouts/img/product/sub_menu_img02.jpg" alt="">
                            ...
                            <div class="header-action d-none d-md-block">
                                <ul>
                                    ...
                                    <li class="sidebar-toggle-btn"><a href="#" class="navSidebar-button"><img src="public/layouts/img/icon/sidebar_toggle_icon.png" alt=""></a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                    ...
                    <div class="mobile-menu">
                        ...
                        <nav class="menu-box">
                            <div class="nav-logo"><a href="index.html"><img src="public/layouts/img/logo/logo.png" alt="" title=""></a>
                            </div>
                    ...
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            <div class="logo mb-30">
                                <a href="index.html"><img src="public/layouts/img/logo/logo.png" alt=""></a>
                            </div>
